function main(container, outline, toolbar, sidebar)
{
    ...
    mxConnectionHandler.prototype.connectImage = new mxImage(`${assetsBase}/images/connector.gif`, 16, 16);

    // Prefetches all images that appear in colums
    // to avoid problems with the auto-layout
    var keyImage = new Image();
    keyImage.src = `${assetsBase}/images/key.png`;

    var plusImage = new Image();
    plusImage.src = `${assetsBase}/images/plus.png`;

    var checkImage = new Image();
    checkImage.src = `${assetsBase}/images/check.png`;
    ...
    var config = mxUtils.load(
        `${assetsBase}/keyhandler-minimal.xml`).getDocumentElement();
    ...
    graph.getLabel = function (cell)
    {
        if (this.isHtmlLabel(cell))
        {
            ...
            {
                label += `<img title="Primary Key" src="${assetsBase}/images/key.png" width="16" height="16" align="top">&nbsp;`;
            }
            else
            {
                label += `<img src="${assetsBase}/images/spacer.gif" width="16" height="1">&nbsp;`;
            }

            if (cell.value.autoIncrement)
            {
                label += `<img title="Auto Increment" src="${assetsBase}/images/plus.png" width="16" height="16" align="top">&nbsp;`;
            }
            else if (cell.value.unique)
            {
                label += `<img title="Unique" src="${assetsBase}/images/check.png" width="16" height="16" align="top">&nbsp;`;
            }
            else
            {
                label += `<img src="${assetsBase}/images/spacer.gif" width="16" height="1">&nbsp;`;
    ...
    addSidebarIcon(graph, sidebar, table, `${assetsBase}/images/icons48/table.png`);
    ...
    addSidebarIcon(graph, sidebar, column, `${assetsBase}/images/icons48/column.png`);
    ...
    addToolbarButton(editor, toolbar, 'properties', 'Properties', `${assetsBase}/images/properties.gif`);
    ...
    addToolbarButton(editor, toolbar, 'delete', 'Delete', `${assetsBase}/images/delete2.png`);

    toolbar.appendChild(spacer.cloneNode(true));

    addToolbarButton(editor, toolbar, 'undo', '', `${assetsBase}/images/undo.png`);
    addToolbarButton(editor, toolbar, 'redo', '', `${assetsBase}/images/redo.png`);

    toolbar.appendChild(spacer.cloneNode(true));

    addToolbarButton(editor, toolbar, 'show', 'Show', `${assetsBase}/images/camera.png`);
    addToolbarButton(editor, toolbar, 'print', 'Print', `${assetsBase}/images/printer.png`);
    ...
    addToolbarButton(editor, toolbar, 'showSql', 'Show SQL', `${assetsBase}/images/export1.png`);
    ...
    addToolbarButton(editor, toolbar, 'export', 'Export XML', `${assetsBase}/images/export1.png`);

    toolbar.appendChild(spacer.cloneNode(true));

    addToolbarButton(editor, toolbar, 'collapseAll', 'Collapse All', `${assetsBase}/images/navigate_minus.png`);
    addToolbarButton(editor, toolbar, 'expandAll', 'Expand All', `${assetsBase}/images/navigate_plus.png`);

    toolbar.appendChild(spacer.cloneNode(true));

    addToolbarButton(editor, toolbar, 'zoomIn', '', `${assetsBase}/images/zoom_in.png`);
    addToolbarButton(editor, toolbar, 'zoomOut', '', `${assetsBase}/images/zoom_out.png`);
    addToolbarButton(editor, toolbar, 'actualSize', '', `${assetsBase}/images/view_1_1.png`);
    addToolbarButton(editor, toolbar, 'fit', '', `${assetsBase}/images/fit_to_size.png`);
    ...
    window.schemaEditorCustomize(editor)
...
function configureStylesheet(graph)
{
    ...
    style[mxConstants.STYLE_IMAGE] = `${assetsBase}/images/icons48/table.png`;
...
function createPopupMenu(editor, graph, menu, cell, evt)
{
    if (cell != null)
    {
        if (graph.isHtmlLabel(cell))
        {
            menu.addItem('Properties', `${assetsBase}/images/properties.gif`, function ()
            {
        ...
        menu.addItem('Delete', `${assetsBase}/images/delete2.png`, function ()
        {
    ...
    menu.addItem('Undo', `${assetsBase}/images/undo.png`, function ()
    {
        editor.execute('undo', cell);
    });

    menu.addItem('Redo', `${assetsBase}/images/redo.png`, function ()
    {
    ...
    menu.addItem('Show SQL', `${assetsBase}/images/export1.png`, function ()
    {
